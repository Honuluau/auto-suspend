...
public class AutoSuspend
{
    ...
    static async Task<int> Routine(String[] args)
    {
        ...
        */
        ...
        /*
        Testing with cloned real data that does not affect the live-server in anyway:
        Note_Id: 98
        Patron_Id: 84
        Loans: 166, 167
        ...
        */
        ...
        Note note = new Note(1, 1, ParseDates.ConvertStringToDateTime("2025-12-03"), StatusType.REINSTATEMENT, 0, SQLInterface.GetInstance(1));
