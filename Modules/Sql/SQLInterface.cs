...
public class SQLInterface
{
    ...
    public static Loan GetLoanFromRow(DataRow row)
    {
        ...
        string policy = row[6].ToString()!;
        string preferredEmail = row[7].ToString()!;
        DateTime loanDate = ParseDates.ConvertStringToDateTime(row[8].ToString()!);
        DateTime dueDate = ParseDates.ConvertStringToDateTime(row[9].ToString()!);
